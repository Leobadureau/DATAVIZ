...
Promise.all([
  fetch('/DATAVIZ/Json/drivers.json').then(res => res.json()),
  fetch('/DATAVIZ/Json/driver_standings.json').then(res => res.json()),
  fetch('/DATAVIZ/Json/races.json').then(res => res.json()),
  fetch('/DATAVIZ/Json/constructors.json').then(res => res.json()),
  fetch('/DATAVIZ/Json/results.json').then(res => res.json()),
  fetch('/DATAVIZ/Json/Team.json').then(res => res.json())
